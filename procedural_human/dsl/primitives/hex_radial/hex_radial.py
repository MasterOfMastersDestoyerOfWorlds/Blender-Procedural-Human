...
from procedural_human.dsl.primitives.hex_radial.hex_radial_nodes import create_hex_profile_spheroid_group
...
class HexRadial:
    ...
    def generate(self, context: GenerationContext, index: int) -> Dict:
        ...
        # Create Hex Group
        hex_group = create_hex_profile_spheroid_group(suffix=f"{context.instance_name}_{index}")
