...
class DSLFileWatcher:
    ...
    def watch_file(self, file_path: str, linked_objects: Optional[List[str]] = None) -> None:
...
def start_watching(dsl_directory: Optional[str] = None) -> DSLFileWatcher:
    ...
    internal_modules = {'__init__.py', 'primitives.py', 'naming.py', 
                       'executor.py', 'generator.py', 'watcher.py', 'operators.py', 'panel.py'}
