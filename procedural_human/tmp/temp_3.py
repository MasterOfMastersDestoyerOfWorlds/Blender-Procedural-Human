...
def create_male_torso__loft_0__group_group():
    ...
    sample_curve_distances.location = (-1008.6491088867188, 210.61245727539062)
    ...
    sample_curve_distances_1.location = (-987.4246826171875, -269.87646484375)
    ...
    spherical_coords.location = (63.44621276855469, -207.9292755126953)
    ...
    construct_vector.location = (785.4392700195312, 65.66142272949219)
    ...
    value.name = "Value"
    value.label = ""
    value.location = (-1471.72021484375, -469.0261535644531)
    ...
    tri_line_1.label = ""
    tri_line_1.location = (1225.32421875, -136.7991943359375)
    ...
    loop_normal_vector.location = (-591.6552734375, -365.14178466796875)
    ...
    vector_math_001.name = "Vector Math.001"
    vector_math_001.label = ""
    vector_math_001.location = (-175.50039672851562, -389.2610168457031)
    vector_math_001.bl_label = "Vector Math"
    ...
    perp_vectors_simple.label = ""
    perp_vectors_simple.location = (454.1908874511719, -409.4233703613281)
    perp_vectors_simple.node_tree = create_perp_vectors_simple_group()
    perp_vectors_simple.bl_label = "Group"
    # Links for perp_vectors_simple
    ...
    mix_angle.label = ""
    mix_angle.location = (462.9020080566406, 63.10090255737305)
    ...
    mix_angle_1.label = ""
    mix_angle_1.location = (468.77911376953125, 304.55242919921875)
    ...
    vector_rotate.name = "Vector Rotate"
    vector_rotate.label = ""
    vector_rotate.location = (409.2780456542969, -457.4920959472656)
    vector_rotate.bl_label = "Vector Rotate"
    vector_rotate.rotation_type = "AXIS_ANGLE"
    ...
    vector_rotate.inputs[4].default_value = Euler((0.0, 0.0, 0.0), 'XYZ')
    # Links for vector_rotate
    links.new(vector_rotate.outputs[0], perp_vectors_simple.inputs[1])
    links.new(vector_rotate.outputs[0], construct_vector.inputs[0])
    links.new(vector_math_001.outputs[0], vector_rotate.inputs[2])
    links.new(spherical_coords_1.outputs[0], vector_rotate.inputs[0])

    math = nodes.new("ShaderNodeMath")
    math.name = "Math"
    math.label = ""
    math.location = (-210.240478515625, -602.5078125)
    math.bl_label = "Math"
    math.operation = "ADD"
    math.use_clamp = False
    # Value
    ...
    math.inputs[2].default_value = 0.5
    # Links for math
    links.new(value.outputs[0], math.inputs[0])

    math_001 = nodes.new("ShaderNodeMath")
    math_001.name = "Math.001"
    math_001.label = ""
    math_001.location = (146.6630859375, -806.3907470703125)
    math_001.bl_label = "Math"
    ...
    math_001.inputs[2].default_value = 0.5
    # Links for math_001
    links.new(math_001.outputs[0], vector_rotate.inputs[3])

    math_002 = nodes.new("ShaderNodeMath")
    math_002.name = "Math.002"
    math_002.label = ""
    math_002.location = (-19.701988220214844, -634.1849365234375)
    math_002.bl_label = "Math"
    ...
    math_002.inputs[2].default_value = 0.5
    # Links for math_002
    links.new(math.outputs[0], math_002.inputs[0])

    angle_between_vectors = nodes.new("GeometryNodeGroup")
    angle_between_vectors.name = "Group.010"
    angle_between_vectors.label = ""
    angle_between_vectors.location = (-285.56524658203125, -776.4906005859375)
    angle_between_vectors.node_tree = create_angle_between_vectors_group()
    angle_between_vectors.bl_label = "Group"
    # Links for angle_between_vectors
    links.new(loop_normal_vector.outputs[0], angle_between_vectors.inputs[1])
    links.new(loop_normal_vector_1.outputs[0], angle_between_vectors.inputs[0])
    links.new(angle_between_vectors.outputs[0], math_001.inputs[1])

    viewer_003 = nodes.new("GeometryNodeViewer")
    viewer_003.name = "Viewer.003"
    viewer_003.label = ""
    viewer_003.location = (465.52569580078125, -910.97119140625)
    viewer_003.bl_label = "Viewer"
    viewer_003.ui_shortcut = 0
    viewer_003.active_index = 0
    viewer_003.domain = "AUTO"
    # Links for viewer_003
    links.new(math_001.outputs[0], viewer_003.inputs[0])

    math_003 = nodes.new("ShaderNodeMath")
    math_003.name = "Math.003"
    math_003.label = ""
    math_003.location = (-972.1250610351562, -674.115234375)
    math_003.bl_label = "Math"
    ...
    math_003.inputs[2].default_value = 0.5
    # Links for math_003
    links.new(math_003.outputs[0], mix_sample.inputs[0])
    links.new(math_003.outputs[0], mix_angle.inputs[0])
    links.new(math_003.outputs[0], mix_angle_1.inputs[0])
    ...
    math_008.use_clamp = False
    # Value
    math_008.inputs[1].default_value = 1.5707950592041016
    # Value
    math_008.inputs[2].default_value = 0.5
    # Links for math_008
    ...
    math_006.name = "Math.006"
    math_006.label = ""
    math_006.location = (-947.095458984375, -875.8441162109375)
    math_006.bl_label = "Math"
    math_006.operation = "SINE"
    math_006.use_clamp = False
    # Value
    ...
    math_009.label = ""
    math_009.location = (-1223.92578125, -922.232666015625)
    math_009.bl_label = "Math"
    math_009.operation = "MULTIPLY"
    math_009.use_clamp = False
    # Value
    math_009.inputs[1].default_value = 1.5707950592041016
    # Value
    math_009.inputs[2].default_value = 0.5
    # Links for math_009
    links.new(math_009.outputs[0], math_006.inputs[0])
    links.new(value.outputs[0], math_009.inputs[0])
