...
def create_mix_angle_group():
    ...
    sample_index.name = "Sample Index"
    sample_index.label = ""
    sample_index.location = (-1110.5211181640625, 199.55441284179688)
    sample_index.bl_label = "Sample Index"
...
def create_male_torso__loft_0__group_group():
    ...
    group_output.name = "Group Output"
    group_output.label = ""
    group_output.location = (1386.555419921875, 815.7308959960938)
    group_output.bl_label = "Group Output"
    group_output.is_active_output = True
    # Links for group_output
    ...
    construct_vector.location = (1140.111083984375, 74.98235321044922)
    ...
    set_position.label = ""
    set_position.location = (1382.0811767578125, 319.9696960449219)
    ...
    viewer.name = "Viewer"
    viewer.label = ""
    viewer.location = (1687.44970703125, 352.43927001953125)
    viewer.bl_label = "Viewer"
    viewer.ui_shortcut = 0
    viewer.active_index = 0
    viewer.domain = "AUTO"
    ...
    spherical_coords_1.location = (70.52486419677734, 234.0281982421875)
    ...
    value.name = "Value"
    value.label = ""
    value.location = (-595.0641479492188, -652.3739624023438)
    ...
    mix_angle.label = ""
    mix_angle.location = (737.4769897460938, -35.33924102783203)
    ...
    mix_angle_1.label = ""
    mix_angle_1.location = (476.21875, 311.9036560058594)
    mix_angle_1.node_tree = create_mix_angle_group()
    mix_angle_1.bl_label = "Group"
    # Switch
    mix_angle_1.inputs[7].default_value = False
    ...
    math_008.name = "Math.008"
    math_008.label = ""
    math_008.location = (-1238.640869140625, -714.0476684570312)
    math_008.bl_label = "Math"
    ...
    node_group.label = ""
    node_group.location = (150.36050415039062, -697.7560424804688)
    ...
    links.new(node_group.outputs[1], mix_angle.inputs[7])

    switch = nodes.new("GeometryNodeSwitch")
    switch.name = "Switch"
    switch.label = ""
    switch.location = (972.7379150390625, -489.22308349609375)
    switch.bl_label = "Switch"
    switch.input_type = "FLOAT"
    # Links for switch
    ...
    math_002.name = "Math.002"
    math_002.label = ""
    math_002.location = (689.8224487304688, -623.4384765625)
    math_002.bl_label = "Math"
    math_002.operation = "MULTIPLY"
    math_002.use_clamp = False
    # Value
    ...
    store_named_attribute.name = "Store Named Attribute"
    store_named_attribute.label = ""
    store_named_attribute.location = (1275.6839599609375, -346.7936706542969)
    store_named_attribute.bl_label = "Store Named Attribute"
    store_named_attribute.data_type = "FLOAT"
    store_named_attribute.domain = "POINT"
    # Selection
    store_named_attribute.inputs[1].default_value = True
    # Name
    store_named_attribute.inputs[2].default_value = "ree"
    # Links for store_named_attribute
    links.new(switch.outputs[0], store_named_attribute.inputs[3])
    links.new(store_named_attribute.outputs[0], construct_vector.inputs[6])
    links.new(mix_angle.outputs[1], store_named_attribute.inputs[0])
