...
def create_rotate_modulo_group():
    ...
    vector_rotate.label = ""
    vector_rotate.location = (526.6491088867188, 259.67437744140625)
    ...
    math.name = "Math"
    math.label = ""
    math.location = (4.547645568847656, -320.4614562988281)
    math.bl_label = "Math"
    math.operation = "SUBTRACT"
    math.use_clamp = False
    # Value
    ...
    math_002.name = "Math.002"
    math_002.label = ""
    math_002.location = (-693.8082885742188, -283.2867431640625)
    math_002.bl_label = "Math"
    ...
    integer_math.name = "Integer Math"
    integer_math.label = ""
    integer_math.location = (-463.9339904785156, -421.2248840332031)
    integer_math.bl_label = "Integer Math"
    ...
    compare.name = "Compare"
    compare.label = ""
    compare.location = (-219.57118225097656, -262.9792785644531)
    compare.bl_label = "Compare"
    compare.operation = "EQUAL"
    ...
    switch.name = "Switch"
    switch.label = ""
    switch.location = (243.5647735595703, -176.7859344482422)
    ...
    math_006.name = "Math.006"
    math_006.label = ""
    math_006.location = (-52.51013946533203, 57.21135711669922)
    math_006.bl_label = "Math"
    ...
    switch_001.label = ""
    switch_001.location = (471.3337707519531, -136.82945251464844)
    ...
    math_007.name = "Math.007"
    math_007.label = ""
    math_007.location = (735.771484375, -117.15536499023438)
    math_007.bl_label = "Math"
    math_007.operation = "ADD"
    math_007.use_clamp = False
    # Value
    ...
    math_016.label = ""
    math_016.location = (-250.50552368164062, -913.3746948242188)
...
def create_rotate_and_mix_curves_spherical_group():
    ...
    group_output.name = "Group Output"
    group_output.label = ""
    group_output.location = (1522.1903076171875, 297.538818359375)
    group_output.bl_label = "Group Output"
    group_output.is_active_output = True
    # Links for group_output
    ...
    math_001.name = "Math.001"
    math_001.label = ""
    math_001.location = (-1579.1378173828125, -580.8858642578125)
    math_001.bl_label = "Math"
    math_001.operation = "FLOORED_MODULO"
    math_001.use_clamp = False
    # Value
    ...
    spherical_coords.location = (-504.75579833984375, 153.6869354248047)
    ...
    construct_vector.location = (785.591796875, 317.79595947265625)
    ...
    set_position.label = ""
    set_position.location = (999.4881591796875, 477.386474609375)
    ...
    spherical_coords_1.location = (-451.3078308105469, 498.09075927734375)
    ...
    mix_sample.label = ""
    mix_sample.location = (107.86551666259766, 56.52058410644531)
    ...
    loop_normal_vector.location = (-837.0302734375, -131.14329528808594)
    ...
    loop_normal_vector_1.location = (-686.2548828125, 571.2772216796875)
    ...
    vector_math_001.location = (-523.9987182617188, -199.48719787597656)
    vector_math_001.bl_label = "Vector Math"
    ...
    perp_vectors_simple.label = ""
    perp_vectors_simple.location = (105.12857055664062, -182.69862365722656)
    perp_vectors_simple.node_tree = create_perp_vectors_simple_group()
    perp_vectors_simple.bl_label = "Group"
    # Links for perp_vectors_simple
    ...
    mix_angle.label = ""
    mix_angle.location = (103.17037963867188, 350.4245910644531)
    ...
    mix_angle_1.label = ""
    mix_angle_1.location = (104.03526306152344, 656.1082763671875)
    ...
    rotate_modulo.label = ""
    rotate_modulo.location = (-225.9545135498047, -486.5383605957031)
    rotate_modulo.node_tree = create_rotate_modulo_group()
    rotate_modulo.bl_label = "Group"
    # Links for rotate_modulo
    links.new(loop_normal_vector.outputs[0], rotate_modulo.inputs[2])
    ...
    links.new(math_001.outputs[0], rotate_modulo.inputs[3])

    switch = nodes.new("GeometryNodeSwitch")
    switch.name = "Switch"
    switch.label = ""
    switch.location = (220.41192626953125, -434.00164794921875)
    switch.bl_label = "Switch"
    switch.input_type = "FLOAT"
    # Links for switch
    links.new(switch.outputs[0], mix_angle.inputs[2])
    links.new(spherical_coords_1.outputs[2], switch.inputs[1])

    math_002 = nodes.new("ShaderNodeMath")
    math_002.name = "Math.002"
    math_002.label = ""
    math_002.location = (-67.71385192871094, -595.7294921875)
    math_002.bl_label = "Math"
    math_002.operation = "MULTIPLY"
    math_002.use_clamp = False
    # Value
    ...
    links.new(math_002.outputs[0], switch.inputs[2])

    math = nodes.new("ShaderNodeMath")
    math.name = "Math"
    math.label = ""
    math.location = (-834.8150634765625, -494.9322509765625)
    math.bl_label = "Math"
    ...
    vector_math.name = "Vector Math"
    vector_math.label = ""
    vector_math.location = (-583.0986328125, -896.99853515625)
    vector_math.bl_label = "Vector Math"
    ...
    vector_math.inputs[3].default_value = -1.0
    # Links for vector_math
    links.new(loop_normal_vector_1.outputs[0], vector_math.inputs[0])

    switch_001 = nodes.new("GeometryNodeSwitch")
    switch_001.name = "Switch.001"
    switch_001.label = ""
    switch_001.location = (-523.7911987304688, -665.5043334960938)
    switch_001.bl_label = "Switch"
    switch_001.input_type = "VECTOR"
    # Switch
    switch_001.inputs[0].default_value = True
    # Links for switch_001
    links.new(vector_math.outputs[0], switch_001.inputs[1])
    links.new(loop_normal_vector_1.outputs[0], switch_001.inputs[2])
    links.new(switch_001.outputs[0], rotate_modulo.inputs[1])

    math_003 = nodes.new("ShaderNodeMath")
    math_003.name = "Math.003"
    math_003.label = ""
    math_003.location = (-1361.5262451171875, -673.767333984375)
    math_003.bl_label = "Math"
    ...
    integer_math.name = "Integer Math"
    integer_math.label = ""
    integer_math.location = (-1168.3759765625, -651.522216796875)
    integer_math.bl_label = "Integer Math"
    integer_math.operation = "MODULO"
    # Value
    ...
    reverse_indicies_switch.location = (-915.5428466796875, -284.680419921875)
    ...
    compare_001.name = "Compare.001"
    compare_001.label = ""
    compare_001.location = (-1011.4147338867188, -786.14697265625)
    compare_001.bl_label = "Compare"
    ...
    compare_001.inputs[12].default_value = 0.0010000000474974513
    # Links for compare_001
    links.new(compare_001.outputs[0], reverse_indicies_switch.inputs[2])
    ...
    tri_line.label = ""
    tri_line.location = (1248.875244140625, 154.73297119140625)
    tri_line.node_tree = create_tri_line_group()
    tri_line.bl_label = "Group"
    # Offset
    tri_line.inputs[0].default_value = Vector((0.0, 0.0, 1.0))
    # Offset
    tri_line.inputs[1].default_value = Vector((0.0, 0.0, 1.0))
    # Offset
    tri_line.inputs[2].default_value = Vector((0.0, 0.0, 1.0))
    # Offset
    tri_line.inputs[3].default_value = Vector((0.0, 0.0, 1.0))
    # Links for tri_line

    join_geometry = nodes.new("GeometryNodeJoinGeometry")
    join_geometry.name = "Join Geometry"
    join_geometry.label = ""
    join_geometry.location = (-1542.59033203125, -200.41213989257812)
    join_geometry.bl_label = "Join Geometry"
    # Links for join_geometry
    ...
    attribute_statistic.name = "Attribute Statistic"
    attribute_statistic.label = ""
    attribute_statistic.location = (-1264.4443359375, -66.51165008544922)
    attribute_statistic.bl_label = "Attribute Statistic"
    attribute_statistic.data_type = "FLOAT_VECTOR"
    attribute_statistic.domain = "POINT"
    # Selection
    ...
    links.new(attribute_statistic.outputs[0], rotate_modulo.inputs[4])
...
def create_male_torso__loft_0__group_group():
    ...
    group_output.name = "Group Output"
    group_output.label = ""
    group_output.location = (794.319580078125, -258.9219055175781)
    group_output.bl_label = "Group Output"
    group_output.is_active_output = True
    # Links for group_output
    ...
    index_001.name = "Index.001"
    index_001.label = ""
    index_001.location = (-1876.8272705078125, -206.17288208007812)
    index_001.bl_label = "Index"
    # Links for index_001
    ...
    sample_curve_distances.location = (-1380.254150390625, -407.8458251953125)
    ...
    sample_curve_distances_1.location = (-1146.1357421875, -35.18768310546875)
    ...
    integer.location = (-1851.194091796875, -285.21636962890625)
    ...
    rotate_and_mix_curves_spherical.location = (244.0019989013672, -198.75205993652344)
    ...
    array.name = "Array"
    array.label = ""
    array.location = (-765.6646118164062, -277.3638610839844)
    ...
    for_each_geometry_element_input.location = (-485.4236145019531, -304.70501708984375)
    ...
    for_each_geometry_element_output.location = (450.7870178222656, -264.6394958496094)
    ...
    links.new(rotate_and_mix_curves_spherical.outputs[0], for_each_geometry_element_output.inputs[1])
    links.new(for_each_geometry_element_output.outputs[2], group_output.inputs[0])

    set_i_d = nodes.new("GeometryNodeSetID")
    set_i_d.name = "Set ID"
    set_i_d.label = ""
    set_i_d.location = (-1015.876953125, -485.8687744140625)
    set_i_d.bl_label = "Set ID"
    # Selection
    set_i_d.inputs[1].default_value = True
    # Links for set_i_d
    ...
    integer_001.label = ""
    integer_001.location = (-1175.8489990234375, -583.091796875)
    ...
    set_i_d_001.name = "Set ID.001"
    set_i_d_001.label = ""
    set_i_d_001.location = (-1009.4011840820312, -253.77685546875)
    set_i_d_001.bl_label = "Set ID"
    # Selection
    set_i_d_001.inputs[1].default_value = True
    # Links for set_i_d_001
    ...
    integer_002.label = ""
    integer_002.location = (-1211.982666015625, -290.8934326171875)
    ...
    join_geometry.name = "Join Geometry"
    join_geometry.label = ""
    join_geometry.location = (-924.229736328125, -386.89599609375)
    join_geometry.bl_label = "Join Geometry"
    # Links for join_geometry
    ...
    separate_geometry_001.location = (-5.54437255859375, -290.95465087890625)
    ...
    i_d.name = "ID"
    i_d.label = ""
    i_d.location = (-413.27294921875, -627.0736694335938)
    i_d.bl_label = "ID"
    # Links for i_d
    ...
    sample_index.name = "Sample Index"
    sample_index.label = ""
    sample_index.location = (-124.91588592529297, -530.5040283203125)
    sample_index.bl_label = "Sample Index"
    ...
    compare.name = "Compare"
    compare.label = ""
    compare.location = (26.09917449951172, -520.80908203125)
    compare.bl_label = "Compare"
    compare.operation = "EQUAL"
    compare.data_type = "INT"
    compare.mode = "ELEMENT"
    ...
    realize_instances.name = "Realize Instances"
    realize_instances.label = ""
    realize_instances.location = (-295.9664001464844, -464.1111755371094)
    realize_instances.bl_label = "Realize Instances"
    # Selection
    realize_instances.inputs[1].default_value = True
    # Realize All
    ...
    index_002.name = "Index.002"
    index_002.label = ""
    index_002.location = (-442.8782653808594, -704.9041748046875)
    index_002.bl_label = "Index"
    # Links for index_002
    ...
    math.name = "Math"
    math.label = ""
    math.location = (218.9156494140625, -396.8761291503906)
    math.bl_label = "Math"
    math.operation = "ADD"
    math.use_clamp = False
    # Value
    ...
    integer_003.label = ""
    integer_003.location = (-1110.0328369140625, -848.041748046875)
    integer_003.bl_label = "Integer"
    integer_003.integer = 3
    # Links for integer_003
    links.new(integer_003.outputs[0], array.inputs[3])

    math_001 = nodes.new("ShaderNodeMath")
    math_001.name = "Math.001"
    math_001.label = ""
    math_001.location = (353.12945556640625, -629.5156860351562)
    math_001.bl_label = "Math"
    math_001.operation = "DIVIDE"
    math_001.use_clamp = False
    # Value
    math_001.inputs[2].default_value = 0.5
    # Links for math_001
    links.new(integer_003.outputs[0], math_001.inputs[1])

    math_002 = nodes.new("ShaderNodeMath")
    math_002.name = "Math.002"
    math_002.label = ""
    math_002.location = (154.387451171875, -643.819091796875)
    math_002.bl_label = "Math"
    ...
    links.new(math_002.outputs[0], math_001.inputs[0])

    math_003 = nodes.new("ShaderNodeMath")
    math_003.name = "Math.003"
    math_003.label = ""
    math_003.location = (618.978759765625, -668.572265625)
    math_003.bl_label = "Math"
    math_003.operation = "MULTIPLY"
    math_003.use_clamp = False
    # Value
