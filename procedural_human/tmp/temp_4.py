...
def create_male_torso__loft_0__group_group():
    ...
    spherical_coords_1.location = (93.09494018554688, 235.9705047607422)
    ...
    node_group.label = ""
    node_group.location = (263.1332092285156, -662.6151123046875)
    ...
    math.name = "Math"
    math.label = ""
    math.location = (567.6859741210938, -592.4561157226562)
    math.bl_label = "Math"
    ...
    math.inputs[2].default_value = 0.5
    # Links for math
    links.new(spherical_coords_1.outputs[2], math.inputs[0])

    switch = nodes.new("GeometryNodeSwitch")
    switch.name = "Switch"
    switch.label = ""
    switch.location = (846.6731567382812, -368.94134521484375)
    switch.bl_label = "Switch"
    switch.input_type = "FLOAT"
    # Links for switch
