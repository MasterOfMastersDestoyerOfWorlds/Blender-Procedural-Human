...
def create_curve_rib_cage_group():
    ...
    group_output.name = "Group Output"
    group_output.label = ""
    group_output.location = (2011.9105224609375, 0.0)
    group_output.bl_label = "Group Output"
    group_output.is_active_output = True
    # Links for group_output
    ...
    reroute.name = "Reroute"
    reroute.label = ""
    reroute.location = (-431.40283203125, -403.9544677734375)
    reroute.bl_label = "Reroute"
    ...
    # Links for switch_004
    links.new(switch_004.outputs[0], reroute.inputs[0])
    ...
    set_position.name = "Set Position"
    set_position.label = ""
    set_position.location = (576.0770263671875, 157.12429809570312)
    set_position.bl_label = "Set Position"
    # Offset
    set_position.inputs[3].default_value = Vector((0.0, 0.0, 0.0))
    # Links for set_position
    ...
    sample_index.name = "Sample Index"
    sample_index.label = ""
    sample_index.location = (-719.8206176757812, 201.5815887451172)
    sample_index.bl_label = "Sample Index"
    ...
    # Offset
    array.inputs[10].default_value = Vector((1.0, 0.0, 0.0))
    # Rotation
    ...
    index.name = "Index"
    index.label = ""
    index.location = (-1233.103759765625, -52.63941955566406)
    index.bl_label = "Index"
    # Links for index
    ...
    position.name = "Position"
    position.label = ""
    position.location = (-918.1627807617188, -147.81045532226562)
    position.bl_label = "Position"
    # Links for position
    ...
    sample_index_001.name = "Sample Index.001"
    sample_index_001.label = ""
    sample_index_001.location = (-900.5178833007812, 461.4478759765625)
    sample_index_001.bl_label = "Sample Index"
    ...
    set_position_001.name = "Set Position.001"
    set_position_001.label = ""
    set_position_001.location = (452.4591064453125, 378.2103271484375)
    set_position_001.bl_label = "Set Position"
    # Offset
    set_position_001.inputs[3].default_value = Vector((0.0, 0.0, 0.0))
    # Links for set_position_001
    ...
    store_named_attribute.name = "Store Named Attribute"
    store_named_attribute.label = ""
    store_named_attribute.location = (373.36529541015625, 208.73287963867188)
    store_named_attribute.bl_label = "Store Named Attribute"
    ...
    store_named_attribute.inputs[1].default_value = True
    # Name
    store_named_attribute.inputs[2].default_value = "slected"
    # Links for store_named_attribute
    links.new(compare.outputs[0], store_named_attribute.inputs[3])
    links.new(array.outputs[0], store_named_attribute.inputs[0])
    ...
    math.name = "Math"
    math.label = ""
    math.location = (-1053.0, -57.44103240966797)
    math.bl_label = "Math"
    math.operation = "MULTIPLY"
    math.use_clamp = False
    # Value
