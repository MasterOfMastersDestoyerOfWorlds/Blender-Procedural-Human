...
def create_curve_rib_cage_group():
    ...
    # Index
    debug_handles.inputs[1].default_value = 7
    # Value
...
def create_align_handles_group():
    ...
    math.name = "Math"
    math.label = ""
    math.location = (850.83154296875, 208.50144958496094)
    math.bl_label = "Math"
    ...
    links.new(sample_index_002.outputs[0], set_handle_positions.inputs[3])
    ...
    math_001.name = "Math.001"
    math_001.label = ""
    math_001.location = (910.0147094726562, 613.945068359375)
    math_001.bl_label = "Math"
    math_001.operation = "ADD"
    math_001.use_clamp = False
    # Value
    math_001.inputs[0].default_value = 3.8999998569488525
    # Value
    math_001.inputs[2].default_value = 0.5
    # Links for math_001
...
def create_geometry__nodes_group():
    ...
    integer_math_003.name = "Integer Math.003"
    integer_math_003.label = ""
    integer_math_003.location = (-2314.322021484375, 616.8529663085938)
    integer_math_003.bl_label = "Integer Math"
    ...
    group_output.bl_label = "Group Output"
    group_output.is_active_output = False
    # Links for group_output
    ...
    # Input
    reroute_001.inputs[0].default_value = 0
    # Links for reroute_001
    ...
    switch.name = "Switch"
    switch.label = ""
    switch.location = (-783.064208984375, 794.9926147460938)
    switch.bl_label = "Switch"
    switch.input_type = "GEOMETRY"
    # Switch
    ...
    switch_001.name = "Switch.001"
    switch_001.label = ""
    switch_001.location = (-767.6990966796875, 609.000244140625)
    switch_001.bl_label = "Switch"
    switch_001.input_type = "GEOMETRY"
    # Switch
    ...
    switch_002.name = "Switch.002"
    switch_002.label = ""
    switch_002.location = (-739.762451171875, 407.62506103515625)
    switch_002.bl_label = "Switch"
    switch_002.input_type = "GEOMETRY"
    # Switch
    ...
    switch_003.name = "Switch.003"
    switch_003.label = ""
    switch_003.location = (-784.4610595703125, 976.7901000976562)
    switch_003.bl_label = "Switch"
    switch_003.input_type = "GEOMETRY"
    # Switch
    ...
    curve_rib_cage.location = (-1460.698486328125, 1079.185546875)
    ...
    links.new(group_input_001.outputs[3], curve_rib_cage.inputs[2])
    links.new(orient_curve.outputs[1], curve_rib_cage.inputs[1])
    links.new(integer_math_003.outputs[0], curve_rib_cage.inputs[4])
    links.new(group_input_001.outputs[2], curve_rib_cage.inputs[3])
    ...
    group_output_001.location = (303.3445739746094, 1089.28271484375)
    ...
    curve_rib_cage_1.location = (-1454.3865966796875, 817.9878540039062)
    ...
    links.new(group_input_001.outputs[2], curve_rib_cage_1.inputs[2])
    links.new(get_axis.outputs[4], curve_rib_cage_1.inputs[5])
    links.new(integer_math_003.outputs[0], curve_rib_cage_1.inputs[4])
    links.new(group_input_001.outputs[2], curve_rib_cage_1.inputs[3])

    join_geometry_001 = nodes.new("GeometryNodeJoinGeometry")
    join_geometry_001.name = "Join Geometry.001"
    join_geometry_001.label = ""
    join_geometry_001.location = (-201.73011779785156, 737.8358154296875)
    join_geometry_001.bl_label = "Join Geometry"
    # Links for join_geometry_001
    links.new(switch_003.outputs[0], join_geometry_001.inputs[0])
    links.new(switch_002.outputs[0], join_geometry_001.inputs[0])
    links.new(switch.outputs[0], join_geometry_001.inputs[0])
    links.new(switch_001.outputs[0], join_geometry_001.inputs[0])

    curve_rib_cage_2 = nodes.new("GeometryNodeGroup")
    curve_rib_cage_2.name = "Group.007"
    curve_rib_cage_2.label = ""
    curve_rib_cage_2.location = (-1462.099365234375, 570.601806640625)
    ...
    links.new(group_input_001.outputs[3], curve_rib_cage_2.inputs[4])
    links.new(get_axis.outputs[4], curve_rib_cage_2.inputs[5])
    links.new(group_input_001.outputs[2], curve_rib_cage_2.inputs[3])

    curve_rib_cage_3 = nodes.new("GeometryNodeGroup")
    curve_rib_cage_3.name = "Group.009"
    curve_rib_cage_3.label = ""
    curve_rib_cage_3.location = (-1468.7926025390625, 333.79241943359375)
    ...
    links.new(group_input_001.outputs[2], curve_rib_cage_3.inputs[3])
    links.new(group_input_001.outputs[3], curve_rib_cage_3.inputs[4])
    ...
    curve_to_mesh.label = ""
    curve_to_mesh.location = (-49.05197525024414, 992.3078002929688)
    ...
    join_geometry_002.name = "Join Geometry.002"
    join_geometry_002.label = ""
    join_geometry_002.location = (123.0, 1068.462890625)
    join_geometry_002.bl_label = "Join Geometry"
    # Links for join_geometry_002
    links.new(join_geometry_002.outputs[0], group_output_001.inputs[0])
    links.new(curve_to_mesh.outputs[0], join_geometry_002.inputs[0])
    links.new(group_input_001.outputs[0], join_geometry_002.inputs[0])
    ...
    separate_components.location = (-228.99998474121094, 979.72119140625)
    ...
    align_handles.name = "Group.011"
    align_handles.label = ""
    align_handles.location = (-581.4175415039062, 747.75830078125)
    align_handles.node_tree = create_align_handles_group()
    align_handles.bl_label = "Group"
    # Links for align_handles
    links.new(switch.outputs[0], align_handles.inputs[0])
    links.new(switch_001.outputs[0], align_handles.inputs[1])

    align_handles_1 = nodes.new("GeometryNodeGroup")
    align_handles_1.name = "Group.017"
    align_handles_1.label = ""
    align_handles_1.location = (-580.3671875, 622.6765747070312)
    align_handles_1.node_tree = create_align_handles_group()
    align_handles_1.bl_label = "Group"
    # Links for align_handles_1
    links.new(switch_001.outputs[0], align_handles_1.inputs[0])
    links.new(switch.outputs[0], align_handles_1.inputs[1])
