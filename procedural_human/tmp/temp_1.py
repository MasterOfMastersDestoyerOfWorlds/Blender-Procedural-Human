...
def create_mix_sample_group():
    ...
    math.name = "Math"
    math.label = ""
    math.location = (-331.6895751953125, 33.23085021972656)
    math.bl_label = "Math"
    math.operation = "ADD"
    math.use_clamp = False
    # Value
...
def create_male_torso__loft_0__group_group():
    ...
    mix_sample.label = ""
    mix_sample.location = (478.4825744628906, 336.9178161621094)
    ...
    mix_sample_1.label = ""
    mix_sample_1.location = (478.33740234375, 60.391300201416016)
    ...
    links.new(mix_sample_1.outputs[0], construct_vector.inputs[2])
