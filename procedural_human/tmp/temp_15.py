...
def create_curve_rot_curve_group():
    ...
    map_range.label = ""
    map_range.location = (954.9093017578125, -118.46142578125)
    ...
    # Links for map_range
    links.new(math_001.outputs[0], map_range.inputs[0])
    links.new(map_range.outputs[0], rotate_and_mix_curves_spherical.inputs[3])
