...
from procedural_human.geo_node_groups.node_helpers import compare_op, resample_curve, store_named_attribute
...
def create_blocker_collar_gambeson_pattern_stitching_group():
    ...
    store_named_attribute_003 = store_named_attribute(group, "BOOLEAN", "POINT", realize_instances_001.outputs[0], True, "stitching", True)
    ...
    links.new(store_named_attribute_003, group_output.inputs[0])
