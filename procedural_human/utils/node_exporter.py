...
class NodeGroupExporter:
    ...
    def generate_group_code(self, node_group, function_name):
        ...
        for node in node_group.nodes:
            ...
            if hasattr(node, "node_tree") and node.node_tree:
                 ...
                 dep_func_name = f"create_{to_snake_case(clean_string(node.node_tree.name))}_group"
    ...
    def get_full_code(self):
        ...
        header.append("from procedural_human.utils.node_layout import auto_layout_nodes")
        header.append("")
