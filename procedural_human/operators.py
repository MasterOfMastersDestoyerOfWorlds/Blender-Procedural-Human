...
def register():
    ...
    # Finger operator is registered in hand.finger.operator
    from .hand.finger import operator as finger_operator
...
def unregister():
    ...
    # Finger operator is unregistered in hand.finger.operator
    from .hand.finger import operator as finger_operator
